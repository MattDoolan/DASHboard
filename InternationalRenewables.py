...
def before_first_request_function():
    ...
    # Here you can add any initialization code you need to run before handling the first request
    # For example, loading data, setting up connections, etc.
...
# Load your data before the first request
df = before_first_request_function()
